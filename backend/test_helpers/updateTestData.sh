...
psql -Atx $POSTGRESQL_CONNECTION_STRING -af backend/test_helpers/internal/createTempTablesOfRowsWithSpecificTransactions.sql
...
pg_dump $POSTGRESQL_CONNECTION_STRING $chosenTables --column-inserts > backend/test_helpers/internal/testData.sql
