...
describe('precision helper', () => {
  ...
  test('getLocaleStringToDecimals', () => {
    ...
    expect(getLocaleStringToDecimals(exactMath.formula('4.5e-12', { returnString: true }), 2, locale)).toBe('0.00'); // TODO
    expect(getLocaleStringToDecimals('4_513_263_875_304_671_192_000_009.199867903046702926255639', 20, locale)).toBe('4,513,263,875,304,671,192,000,009.19986790304670292625'); // TODO
  });
  ...
  test('round custom decimals and divisorPower', () => {
    ...
    expect(round('4_513_263_875_304_671_192_000_009.199867903046702926255639', 20, undefined, locale)).toBe('4,513,263,875,304,671,192,000,009.19986790304670292625'); // TODO
  });
});
