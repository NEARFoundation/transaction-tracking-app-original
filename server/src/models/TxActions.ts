...
export function convertFromModelToTxActionRow(txActionModel: TxActionModel): TxActionRow {
  return {
    ...
    block_timestamp: Number(txActionModel.block_timestamp) ?? null, // server/src/models/TxActions.js uses Decimal128 for this field, which React can't display. https://thecodebarbarian.com/a-nodejs-perspective-on-mongodb-34-decimal.html
